            ...
            <div className="flex gap-4">
              ...
              <Button size="icon" variant="ghost" className="text-white hover:text-white hover:bg-white/20 rounded-full focus:outline-none focus:ring-2 focus:ring-white" aria-label="Connect with us on LinkedIn">
                <Link href="https://x.com/lightech_sa" target="_blank" rel="noopener noreferrer">
                  ...
                  <path d="M15.75 0.9375h3.0675000000000003l-6.7 7.6775L20 19.0625h-6.171250000000001l-4.83375 -6.3375 -5.53125 6.3375H0.395l7.16625 -8.2125L0 0.9375h6.328749999999999l4.36875 5.79125L15.75125 0.9375Zm-1.075 16.285h1.7000000000000002L5.4037500000000005 2.68125H3.5812500000000003z" strokeWidth="1.25"></path>
                </svg>
                </Link>
              </Button>
            </div>
