...
const Hero = () => {
  ...
  return (
    ...
    >
        ...
        <div className="max-w-4xl mx-auto space-y-8 backdrop-blur-sm bg-white/5 p-12 rounded-2xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 pt-12">
            ...
            <div key={index} className="backdrop-blur-sm bg-white/5 p-6 rounded-xl">
              <div ref={el => statRefs.current[index] = el} className="text-3xl font-bold text-white mb-2">{stat.value}+</div>
      ...
      <div className="absolute bottom-0 z-10 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
