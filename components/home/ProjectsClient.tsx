...
'use client';  // Client component for state, router, and motion

import { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { Button } from "@/components/ui/button";
import { Project, projects } from "@/lib/projectsData";
import content from "../../public/assets/content.json";  // Static import—fine in client
...
export default function ProjectsClient({ params }: ProjectsClientProps) {
  ...
  const navigateToProject = (slug: string) => {
    ...
    router?.push(`/${language}/projects/${cleanSlug}`);
  };
        ...
        <div className="container mx-auto px-4">
            ...
            <AnimatePresence>
              {filteredProjects.map((project) => (
                <motion.div
                  ...
                  className="group relative rounded-xl overflow-hidden cursor-pointer backdrop-blur-sm bg-white/50 dark:bg-white/10"
          ...
          <h1 className="text-4xl px-8 pt-8 text-primary font-bold tracking-wider mb-2">
            {language === 'en'
              ...
              : 'مشاريعنا الأخرى الجديرة بالملاحظة'}
          </h1>
