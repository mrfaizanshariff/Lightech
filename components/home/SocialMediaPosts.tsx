...
const SocialMediaPosts = () => {
  return (
    <section className='my-10 bg-gray-50 py-8 '>
        ...
        <div className='container mx-auto px-4 grid gap-5 justify-items-center grid-cols-1 custom:grid-cols-3 md:grid-cols-2 content-center'>
        <div >
